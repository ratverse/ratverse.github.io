var minersAddr = '0xeb1C80431b55AE26Ead890CA9F1F9331BcDE945D';
var minersAbi = [{
	"inputs": [{
		"internalType": "string",
		"name": "name",
...
function allEarnedReflectionRead(callback) {
	nftContract.methods.allEarnedReflectionRead().call({
		from: currentAddr
	}).then(result => {
		if (result == '0x') {
			result = 1000;
